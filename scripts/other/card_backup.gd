...
#@export var _intersected_card : Card
	...
	#match card_state:
		...
		#DataManager.CardState.ENTER_STACK:
			...
			##intersected_card = get_closest_card(intersected_areas)
				#if _intersected_card:
					#_intersected_card.add_card_to_stack(self)
